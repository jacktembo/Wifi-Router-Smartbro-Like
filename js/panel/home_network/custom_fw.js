(function($) {
    ...
    $.fn.objCustom_FW = function(InIt) {
        ...
        this.onLoad = function() {
            ...
            $(_xml).find("custom_rules_list").each(function() {
                $(this).find("Item").each(function() {
                    ruleName = $(this).find("rule_name").text();
        ...
        this.postCustomFWItem = function(index, isDeleted, name, enabled, src_ip, src_nm, src_port, dst_ip, dst_nm, dst_port, protocol) {
            ...
            if (isDeleted) {
                var _name = encodeURIComponent(_arrayTableDataCustomFW[index][1]);
...
function customFWRuleClicked(index) {
    ...
    if ("" != data[3] && "NA" != data[3]  ) {
        var ip = data[3].split("index.html")[0];
        var netmask = data[3].split("index.html")[1];
    ...
    if ("" != data[5]&& "NA" != data[5]) {
        var ip = data[5].split("index.html")[0];
        var netmask = data[5].split("index.html")[1];
        if (undefined != ip.split(".")[0]) {
...
function btnOKClickedCustomFW() {
    ...
    if (name != "") {
        ...
        if (flag == 0) {
            ...
            document.getElementById("lCustomFWError").style.display = "block";
            document.getElementById("lCustomFWError").innerHTML = jQuery.i18n.prop("lPortNumInvalide");
        } else if (flag == 4) {
            document.getElementById("lCustomFWError").style.display = "block";
            document.getElementById("lCustomFWError").innerHTML = jQuery.i18n.prop("lStartPortLarger");
        } else if (flag == 5) {
            document.getElementById("lCustomFWError").style.display = "block";
